    ...
    <div className="grid md:grid-cols-2 gap-px bg-foreground/10 border border-foreground/10">
      {docs.map((d, i) => (
        ...
        >
          ...
          <span className="label group-hover:text-terracotta transition-colors duration-500">Read →</span>
        </Link>
      ))}
    </div>
  );
